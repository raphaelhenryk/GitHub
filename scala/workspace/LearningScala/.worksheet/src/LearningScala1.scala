object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(2616); 
  ...
  val valuePi : Double = 3.14
  val doublePi = valuePi * 2
  
  println(s"O valor de pi vezes 2 é igual à $doublePi")
